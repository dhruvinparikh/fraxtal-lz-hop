...
// forge script src/script/hop/Remote/DeployRemoteHopPlasma.sol --rpc-url https://rpc.plasma.to --broadcast
contract DeployRemoteHopPlasma is DeployRemoteHop {
    constructor() {
        ...
        owner = 0x7d99C7737751b044DF4fA10aeEFA31532dd11DBE;
    }
}
